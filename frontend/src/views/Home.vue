<template>
	<main>
	  ...
	  <!--- start Sorter ---->
	  <Sorter :btn="true" :products="products"><!--:products="products"-->
  	    <div class="view_title">
...
export default{
	...
	async mounted(){
		...
		await axios.get("api/products/bycategory/4/?limit=4&random=True")
				   .then(response =>{
				   		this.productJacket = response.data
				   })
		await axios.get("api/products/bycategory/3/?limit=4&random=True")
				   .then(response =>{
