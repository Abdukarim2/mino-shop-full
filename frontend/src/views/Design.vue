					...
					<div class="design_block">
						<div class="design_block_items">
							<div class="design_image">
								<div class="image_change_color" :style="'background-color:' + design.tShrtColor + ';'"
									ref="toImg">
									<div class="writer_text">
										...
										align-items: center;`" @mousemove="clientMousemove($event)" @touchmove="clientMousemove($event)"
											@mouseleave="activate = false" @touchcanel="activate = false"
											class="moverBlock">
											<p class="design_text" :style="'font-size:' + design.textSize + 'px;' +
											'color:' + design.textColor + ';' +
											'font-family:' + design.fontFamily + ';'" @mousedown="clientMousedown($event)"
												@touchstart="clientMousedown($event)" @mouseup="clientMouseup($event)"
												@touchend="clientMouseup($event)" ref="textMover">
												{{ design.text }}
											</p>
										</div>
									</div>
									<a v-if="$route.params.item === 't-shirt'">
										<img src="@/assets/img/t-shirt2.png" class="assets">
									</a>
									<a v-if="$route.params.item === 'mug'">
										<img src="@/assets/img/mug-design.png" class="assets">
									</a>
								</div>
							</div>
							<div class="design_tools">
								...
								<div class="size_changer design_tools_blocks" v-if="$route.params.item === 't-shirt'">
								...
								<div class="material design_tools_blocks" v-if="$route.params.item === 't-shirt'">
...
.color_changer .selection_blocks .selection_block:nth-child(1) {
	background-color: #fff;
}

.color_changer .selection_blocks .selection_block:nth-child(2) {
	background-color: #000;
}

.color_changer .selection_blocks .selection_block:nth-child(3) {
	background-color: #CA8970;
}

.color_changer .selection_blocks .selection_block:nth-child(4) {
	background-color: #FFD600;
}

.color_changer .selection_blocks .selection_block:nth-child(5) {
	background-color: #DBDBDD;
}

.color_changer .selection_blocks .selection_block:nth-child(6) {
	background-color: #7C18FB;
}

.size_changer .selection_blocks .selection_block:hover {
	background-color: #DBDBDD;
}
